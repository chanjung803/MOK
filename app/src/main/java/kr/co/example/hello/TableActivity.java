    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogView = (View) View.inflate(TableActivity.this,R.layout.infodialog,null);
        ...
        for(i=0;i<numButtons.length;i++){
            final int index;
            index = i;
            int[] index2 = {401, 402, 403, 404, 301, 302, 303, 201, 202, 203, 204, 101, 102, 103, 104};
            numButtons[index].setOnClickListener(new View.OnClickListener(){
                public void onClick(View view){
                    //더 구현 : 클릭 시 색 바뀌는거
                    if (index<14){
                        seat.setText((index2[index])+"호"); //버튼 번호를 받아와 띄움
                        personnel.setText("1인");
                        seat.setTextColor(Color.BLUE);
                        personnel.setTextColor(Color.BLUE);
                        Toast.makeText(getApplicationContext(),
                                "1인"+(index2[index])+"호 강의실을 선택하셨습니다.",Toast.LENGTH_SHORT).show();
                    }
                    else{
                        seat.setText((index2[index])+"호"); //버튼 번호를 받아와 띄움
                        ...
                        personnel.setTextColor(Color.BLUE);
                        Toast.makeText(getApplicationContext(),
                                "4인"+(index2[index])+"호 강의실을 선택하셨습니다.",Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }//for문 끝
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(seat.length() <= 0 || tvName.length() <= 0 || tvPhone.length() <= 0){ //좌석 정보 없으면 인원 정보도 없는 것
                    ...
                    if(seat.length() <= 0){
                        Toast.makeText(getApplicationContext(),"강의실을 선택하세요"
                                ,Toast.LENGTH_SHORT).show();
                    }
